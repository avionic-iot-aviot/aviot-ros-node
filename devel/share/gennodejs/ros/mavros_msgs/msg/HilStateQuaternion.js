...
const geographic_msgs = _finder('geographic_msgs');
...
class HilStateQuaternion {
  ...
  static getMessageSize(object) {
    ...
    // 136 is precalculated sum of the constant length fields
    return length + 136;
  }

  static datatype() {
    // Returns string type for a mavros_msgs/HilStateQuaternion object
