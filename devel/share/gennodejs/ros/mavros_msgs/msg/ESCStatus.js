...
const ESCStatusItem = require('./ESCStatusItem.js');
...
class ESCStatus {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.esc_status.length; ++i) {
      length += ESCStatusItem.getMessageSize(object.esc_status[i]);
    }
  ...
  static datatype() {
    // Returns string type for a mavros_msgs/ESCStatus object
