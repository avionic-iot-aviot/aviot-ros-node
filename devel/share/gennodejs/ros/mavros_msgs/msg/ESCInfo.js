...
const ESCInfoItem = require('./ESCInfoItem.js');
...
class ESCInfo {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.esc_info.length; ++i) {
      length += ESCInfoItem.getMessageSize(object.esc_info[i]);
    }
  ...
  static datatype() {
    // Returns string type for a mavros_msgs/ESCInfo object
