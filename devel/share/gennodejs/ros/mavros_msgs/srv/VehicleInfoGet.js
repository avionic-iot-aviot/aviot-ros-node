...
const VehicleInfo = require('../msg/VehicleInfo.js');
...
class VehicleInfoGetRequest {
  ...
  static datatype() {
    // Returns string type for a mavros_msgs/VehicleInfoGetRequest object
...
class VehicleInfoGetResponse {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.vehicles.length; ++i) {
      length += VehicleInfo.getMessageSize(object.vehicles[i]);
    }
  ...
  static datatype() {
    // Returns string type for a mavros_msgs/VehicleInfoGetResponse object
