...
const FileEntry = require('../msg/FileEntry.js');
...
class FileListRequest {
  ...
  static datatype() {
    // Returns string type for a mavros_msgs/FileListRequest object
...
class FileListResponse {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.list.length; ++i) {
      length += FileEntry.getMessageSize(object.list[i]);
    }
  ...
  static datatype() {
    // Returns string type for a mavros_msgs/FileListResponse object
