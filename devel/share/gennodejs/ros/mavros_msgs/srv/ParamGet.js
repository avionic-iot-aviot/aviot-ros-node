...
const ParamValue = require('../msg/ParamValue.js');
...
class ParamGetRequest {
  ...
  static datatype() {
    // Returns string type for a mavros_msgs/ParamGetRequest object
...
class ParamGetResponse {
  ...
  static datatype() {
    // Returns string type for a mavros_msgs/ParamGetResponse object
