...
class MountConfigureRequest {
  ...
  static getMessageSize(object) {
    ...
    // 7 is precalculated sum of the constant length fields
    return length + 7;
  }

  static datatype() {
    // Returns string type for a mavros_msgs/MountConfigureRequest object
...
class MountConfigureResponse {
  ...
  static datatype() {
    // Returns string type for a mavros_msgs/MountConfigureResponse object
