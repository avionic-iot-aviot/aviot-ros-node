...
const Waypoint = require('../msg/Waypoint.js');
...
class WaypointPushRequest {
  ...
  static datatype() {
    // Returns string type for a mavros_msgs/WaypointPushRequest object
...
class WaypointPushResponse {
  ...
  static datatype() {
    // Returns string type for a mavros_msgs/WaypointPushResponse object
