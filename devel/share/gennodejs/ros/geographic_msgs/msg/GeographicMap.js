...
const MapFeature = require('./MapFeature.js');
...
class GeographicMap {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.features.length; ++i) {
      length += MapFeature.getMessageSize(object.features[i]);
    }
  ...
  static datatype() {
    // Returns string type for a geographic_msgs/GeographicMap object
