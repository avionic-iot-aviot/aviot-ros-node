...
const GeoPoseStamped = require('./GeoPoseStamped.js');
...
class GeoPath {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.poses.length; ++i) {
      length += GeoPoseStamped.getMessageSize(object.poses[i]);
    }
  ...
  static datatype() {
    // Returns string type for a geographic_msgs/GeoPath object
