...
const RoutePath = require('../msg/RoutePath.js');
...
class GetRoutePlanRequest {
  ...
  static datatype() {
    // Returns string type for a geographic_msgs/GetRoutePlanRequest object
...
class GetRoutePlanResponse {
  ...
  static datatype() {
    // Returns string type for a geographic_msgs/GetRoutePlanResponse object
