...
const BoundingBox = require('../msg/BoundingBox.js');

//-----------------------------------------------------------

const GeographicMap = require('../msg/GeographicMap.js');
...
class GetGeographicMapRequest {
  ...
  static datatype() {
    // Returns string type for a geographic_msgs/GetGeographicMapRequest object
...
class GetGeographicMapResponse {
  ...
  static datatype() {
    // Returns string type for a geographic_msgs/GetGeographicMapResponse object
