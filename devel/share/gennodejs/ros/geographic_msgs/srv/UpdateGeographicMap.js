...
const GeographicMapChanges = require('../msg/GeographicMapChanges.js');
...
class UpdateGeographicMapRequest {
  ...
  static datatype() {
    // Returns string type for a geographic_msgs/UpdateGeographicMapRequest object
...
class UpdateGeographicMapResponse {
  ...
  static datatype() {
    // Returns string type for a geographic_msgs/UpdateGeographicMapResponse object
