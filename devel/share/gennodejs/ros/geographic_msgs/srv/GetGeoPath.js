...
const GeoPoint = require('../msg/GeoPoint.js');

//-----------------------------------------------------------

const GeoPath = require('../msg/GeoPath.js');
...
class GetGeoPathRequest {
  ...
  static datatype() {
    // Returns string type for a geographic_msgs/GetGeoPathRequest object
...
class GetGeoPathResponse {
  ...
  static datatype() {
    // Returns string type for a geographic_msgs/GetGeoPathResponse object
