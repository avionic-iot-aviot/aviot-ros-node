...
class SubscriberImpl extends EventEmitter {
    ...
    switch(opCode){
      ...
      case 0:
        ...
        if(blkN === 1){
          ...
          console.log(dgramMsg.slice(12).toString())
        } else {
          this._udpMessage = {
            blkN,
            msgId,
      ...
      case 1:
        if(msgId === this._udpMessage.msgId && connectionId === this._udpMessage.connectionId){
          ...
          if(this._udpMessage.blkN -1 === header.blkN ){
            ...
            console.log(Buffer.from(this._udpMessage.buffer).toString())
          }
        }
        break
  ...
  _handleUdpTopicRequestResponse(resp, nodeUri){
    ...
    console.log("_handleUdpTopicRequestResponse", resp)
    let hh = UdprosUtils.parseUdpRosHeader(resp[2][5])
    this._connectionId = resp[2][3]
    console.log("_handleUdpTopicRequestResponse: header: ", hh)
